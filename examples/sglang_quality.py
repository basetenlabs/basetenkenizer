#!/usr/bin/env python3
"""
Compare eval quality between basetenkenizer-patched and stock SGLang tokenizer.

Sequentially launches SGLang servers with and without basetenkenizer patching,
...
def _print_comparison(
    ...
    print()
    print("=" * _W)
    print(f"  SGLang Quality: baseline vs basetenkenizer ({eval_name})")
    print(f"  Model: {model}")
    print("=" * _W)
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Compare eval quality between basetenkenizer-patched and stock "
    ...
    group.add_argument(
        ...
        help="Only run the patched (basetenkenizer) eval",
    )
