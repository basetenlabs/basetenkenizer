...
fn print_summary(
    ...
    println!("  basetenkenizer total:{ft_ms:>10.2} ms");
...
fn bench_sequential(
    ...
    for (i, chunk) in chunks.iter().enumerate() {
        ...
        let enc = tokenizer
            ...
            .context("basetenkenizer encode failed")?;
        let t2 = Instant::now();
...
fn bench_batched(
    ...
    for (batch_idx, batch) in chunks.chunks(batch_size).enumerate() {
        ...
        let ft_results = tokenizer
            ...
            .context("basetenkenizer encode_batch failed")?;
        let t2 = Instant::now();
...
fn main() -> Result<()> {
    ...
    let tokenizer = basetenkenizer::Tokenizer::from_model(&args.model)
        .context("failed to load basetenkenizer tokenizer")?;
        ...
        .map(|path| {
            ...
            writeln!(
                ...
                "input_index,input_char_len,output_token_len,\
                 hf_duration_ms,basetenkenizer_duration_ms"
            )
