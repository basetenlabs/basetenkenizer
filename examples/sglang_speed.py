#!/usr/bin/env python3
"""
Benchmark basetenkenizer vs stock tokenizer in SGLang serving.

Launches SGLang servers with and without basetenkenizer patching in parallel,
    ...
    *,
    ...
    if patched:
        cmd = [
            sys.executable,
            "-c",
            "import basetenkenizer; basetenkenizer.patch_transformers(); "
...
def _print_comparison(
    ...
    print()
    print("=" * _W)
    print("  SGLang Benchmark: baseline vs basetenkenizer  (max_tokens=1)")
    print(f"  Model: {model}")
    print("=" * _W)
